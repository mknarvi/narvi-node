...
exports.Files = NarviResource_1.NarviResource.extend({
    ...
    async upload(params, options = {}) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const fileHash = crypto
                ...
                .update(file.data)
                .digest('hex');
            const signature = (0, utils_1.getNarviRequestSignature)({
            ...
            const headers = Object.assign(Object.assign({}, (0, utils_1.getNarviRequestHeaders)({
