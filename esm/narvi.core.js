...
const defaultRequestSenderFactory = (narvi) => new RequestSender(narvi);
export function createNarvi(platformFunctions, requestSender = defaultRequestSenderFactory) {
    Narvi.PACKAGE_VERSION = version;
    Narvi.USER_AGENT = Object.assign({ bindings_version: Narvi.PACKAGE_VERSION, lang: 'node', publisher: 'narvi', uname: null, typescript: false }, determineProcessUserAgentProperties());
